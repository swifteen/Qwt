...
double CpuStat::average() const
{
    ...
    if ( file.open(IO_ReadOnly) )
	{
		...
		QString line = textStream.readLine().stripWhiteSpace();
		QStringList valueList = QStringList::split(" ", line);
		if ( valueList.count() == 5 )
			avg = valueList[2].toDouble() * 100.0;
	}
