...
# PROP Target_Dir ""
# ADD CPP -MD /W3 /I "..\..\include" /I "$(QTDIR)\include" /I "V:\cvs\qwt\examples\radio" /I "moc" /I "v:\lib\qt\qt3_vc6\mkspecs\win32-msvc" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QWT_DLL /D QT_THREAD_SUPPORT /D "QT_NO_DEBUG" /FD /c -nologo -Zm200 -O1 
...
# PROP Target_Dir ""
# ADD CPP -MDd /W3 /GZ /ZI /Od /I "..\..\include" /I "$(QTDIR)\include" /I "V:\cvs\qwt\examples\radio" /I "moc" /I "v:\lib\qt\qt3_vc6\mkspecs\win32-msvc" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D UNICODE /D QT_DLL /D QWT_DLL /D QT_THREAD_SUPPORT /FD /c -nologo -Zm200 -Zi  
...
USERDEP_ampfrm=""$(QTDIR)\bin\moc.exe""

!IF  "$(CFG)" == "radio - Win32 Release"

# Begin Custom Build - Moc'ing ampfrm.h...
InputPath=.\ampfrm.h


BuildCmds= \
	$(QTDIR)\bin\moc ampfrm.h -o moc\moc_ampfrm.cpp \

"moc\moc_ampfrm.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
...
USERDEP_tunerfrm=""$(QTDIR)\bin\moc.exe""

!IF  "$(CFG)" == "radio - Win32 Release"

# Begin Custom Build - Moc'ing tunerfrm.h...
InputPath=.\tunerfrm.h


BuildCmds= \
	$(QTDIR)\bin\moc tunerfrm.h -o moc\moc_tunerfrm.cpp \

"moc\moc_tunerfrm.cpp" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
...
SOURCE=moc\moc_ampfrm.cpp
# End Source File
# Begin Source File

SOURCE=moc\moc_tunerfrm.cpp
# End Source File
